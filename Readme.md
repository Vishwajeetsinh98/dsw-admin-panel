...
|   POST    |     /forward    |    {eventId: String, roles: String} where roles is a comma separated string.                        |    Redirect to Home                  |      Redirect to home with failure message    |  To forward the event without approving or rejecting it   | dsw, superAdmin |
...
|   POST    |     /forward    |    {eventId: String, roles: String}  where roles is a comma separated string.                      |    Redirect to Home                  |      Redirect to home with failure message    |  To forward the event without approving or rejecting it   | clubAdmin, chapterAdmin |
